...
define('_AM_XSNS_TITLE_CATEGORY_CONFIG', 'Group Category Manager');
...
define('_AM_XSNS_CATEGORY_DEL_CONFIRM', 'When medium category is deleted, also the small category which corresponds is deleted everything. \\n\\nMay I delete it?');
