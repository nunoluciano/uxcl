...
// admin menus
define( $constpref.'_ADMENU_CONTENTSADMIN' , 'Content List' ) ;
define( $constpref.'_ADMENU_CATEGORYACCESS' , 'Categories Permissions' ) ;
...
define($constpref.'_USE_REWRITEDSC','Depends on your environment. If you turn this on, rename .htaccess.rewrite_wraps(with wraps) or htaccess.rewrite_normal(without wraps) to .htaccess under XOOPS_ROOT_PATH/modules/(dirname)/');
define($constpref.'_WRAPSAUTOREGIST','enable auto-registering HTML wrapped files into DB as content');
...
define($constpref.'_LISTASINDEX',"Display content index in category's top");
define($constpref.'_LISTASINDEXDSC','YES makes an auto-made list displayed on top of category. NO makes only content with the highest priority to be displayeed instead of auto-made list');
define($constpref.'_SHOW_BREADCRUMBS','Display Breadcrumbs');
define($constpref.'_SHOW_PAGENAVI','Display Page Navigation');
define($constpref.'_SHOW_PRINTICON','Display Print Icon');
define($constpref.'_SHOW_TELLAFRIEND','Display Tell-A-Friend Iicon');
define($constpref.'_SEARCHBYUID','Enable Concept of Poster');
define($constpref.'_SEARCHBYUIDDSC','Content will be listed in user profile and posts. If you use this module as static content, turn this off.');
...
define($constpref.'_FILTERSDEFAULT','xoopstpl');
...
define($constpref.'_FILTERSPDSC','input filter names separated with | (pipe). Ex. all filters: htmlspecialchars|xcode|smiley|nl2br|xoopstpl');
define($constpref.'_SUBMENU_SC','Show Content in Submenu');
define($constpref.'_SUBMENU_SCDSC','Only categories are displayed by default. If you turn this on, contents marked "menu" will be also displayed');
define($constpref.'_SITEMAP_SC','Show contents in sitemap module');
define($constpref.'_USE_VOTE','Use the like feature VOTE');
...
define($constpref.'_EFIMAGES_SIZEDSC' , '(main_width)x(main_height) (small_width)x(small_height) by default 480x480 128x128');
...
define($constpref.'_BNAME_SUBCATEGORIES','Sub-categories');
