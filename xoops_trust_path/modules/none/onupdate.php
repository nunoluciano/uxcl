...
eval( ' function xoops_module_update_'.$mydirname.'( $module ) { return none_onupdate_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'none_onupdate_base' ) ) {

    function none_onupdate_base( $module , $mydirname )
    {
        ...
        if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
            ...
            $root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUpdate.' . ucfirst($mydirname) . '.Success', 'none_message_append_onupdate' ) ;
            $msgs = array() ;
        } else {
    ...
    function none_message_append_onupdate( &$module_obj , &$log )
    {
