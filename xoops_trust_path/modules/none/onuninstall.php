...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return none_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'none_onuninstall_base' ) ) {

    function none_onuninstall_base( $module , $mydirname )
    {
        ...
        if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
            ...
            $root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'none_message_append_onuninstall' ) ;
            $ret = array() ;
        } else {
    ...
    function none_message_append_onuninstall( &$module_obj , &$log )
    {
