...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return dbcss_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'dbcss_oninstall_base' ) ) {

function dbcss_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'dbcss_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function dbcss_message_append_oninstall( &$module_obj , &$log )
{
