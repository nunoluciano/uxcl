...
{
	return dbcss_global_search_base( "'.$mydirname.'" , $keywords , $andor , $limit , $offset , $userid ) ;
}

' ) ;


if( ! function_exists( 'dbcss_global_search_base' ) ) {

function dbcss_global_search_base( $mydirname , $keywords , $andor , $limit , $offset , $userid )
{
