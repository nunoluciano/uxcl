...
function weblinks_xwords_autolink($queryarray,$id)
	{
	global $xoopsDB;

	$sql = "SELECT lid,title FROM ".$xoopsDB->prefix("weblinks_link")." WHERE lid != '$id' ";
...
/*
function weblinks_xwords_StripCodes( $text )
	{
	return $text;
	}
*/
