...
function xfsection_xwords_autolink($queryarray, $id)
	{
	global $xoopsDB;

	$sql = "SELECT articleid,title FROM ".$xoopsDB->prefix("xfs_article")." WHERE articleid != '$id' AND published > '0' AND published <= '".time()."' ";
...
/*
function xfsection_xwords_StripCodes( $text )
	{
	return $text;
	}
*/
