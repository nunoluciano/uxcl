...
//		$ret = '<h4>'.$this->getTitle().'</h4>'.$this->_permDesc.'<br />';
		$ret = '<fieldset style="margin:1em 0em 0em 0em;border:1px solid #778;"><legend style="font-weight: bold; color: #900;">'.$this->getTitle().'</legend><br />'.$this->_permDesc;
		...
		$ret .= "</table>".$xoopsGTicket->getTicketHtml(__LINE__)."</form></fieldset>";
		return $ret;
	}
}
