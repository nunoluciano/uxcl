...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return dbcss_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'dbcss_onuninstall_base' ) ) {

function dbcss_onuninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'dbcss_message_append_onuninstall' ) ;
		$ret = array() ;
	} else {
...
function dbcss_message_append_onuninstall( &$module_obj , &$log )
{
